...
create table mf_user(	
	u_id int(8) auto_increment primary key,
	account varchar(100), #账号	
	pwd varchar(32), #密码
	nick varchar(100) default '会员', #昵称
	h_img varchar(100), #头像
	paypwd varchar(32), #支付密码
	email varchar(100), #邮箱
	qq int(12), #QQ*/
	u_money float default 0, #财富 初始给它零
	u_st int(2), #状态
	regtime timestamp default current_timestamp, #注册时间
	lasttime timestamp, #登陆时间
	address varchar(30) default "未知", #地址
	profile varchar(100), #个人简介
...
INSERT INTO mf_shop(s_name,s_img,s_pri,s_details,s_sum,s_num,s_des)VALUES('暑期', 'pro_11.jpg','1111','曼谷','100','65','曼谷');
INSERT INTO mf_shop(s_name,s_img,s_pri,s_details,s_sum,s_num,s_des)VALUES('暑期1', 'pro_12.jpg','2222','曼谷','100','65','曼谷');
INSERT INTO mf_shop(s_name,s_img,s_pri,s_details,s_sum,s_num,s_des)VALUES('暑期2', 'pro_13.jpg','5555','曼谷','100','65','曼谷');
INSERT INTO mf_shop(s_name,s_img,s_pri,s_details,s_sum,s_num,s_des)VALUES('暑期3', 'pro_14.jpg','3333','曼谷','100','65','曼谷');
INSERT INTO mf_shop(s_name,s_img,s_pri,s_details,s_sum,s_num,s_des)VALUES('暑期4', 'pro_15.jpg','7777','曼谷','100','65','曼谷');
INSERT INTO mf_shop(s_name,s_img,s_pri,s_details,s_sum,s_num,s_des)VALUES('暑期5', 'pro_16.jpg','6666','曼谷','100','65','曼谷');
...
create table mf_orderlist(
	...
	ol_ordertime timestamp default current_timestamp,#下单时间
	ol_num int(8),	#数量
	u_id int(8),	#用户外键
	s_id int(8),	#商品外键
	os_id int(2) default 2	#订单状态外键
...
-- 商品评论表
drop table if exists mf_comments;
...
create table mf_message(
	msg_id int(4) auto_increment primary key,
	account varchar(16), #用户账号
	time timestamp not null default current_timestamp,
	msg_con varchar(100) not null
);
